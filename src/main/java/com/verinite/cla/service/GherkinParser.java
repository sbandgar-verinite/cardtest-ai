	...
	public static GherkinFormat parseGherkin(String gherkinText) {
        ...
        for (String line : lines) {
            ...
            if (line.startsWith("Feature:") || line.startsWith("**Feature:")) {
                ...
                inScenario = true;
                steps = new ArrayList<>();
            } else if (line.startsWith("Given") || line.startsWith("When") || line.startsWith("Then") || line.startsWith("And") || line.startsWith("GIVEN") || line.startsWith("WHEN") || line.startsWith("THEN") || line.startsWith("AND")) {
                if (inScenario) {
                	steps.add(line.trim());
                }
            }	
